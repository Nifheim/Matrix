...
public abstract class MatrixAPIImpl extends MatrixAPI {
    ...
    public MatrixAPIImpl(@NotNull MatrixPlugin plugin) {
        ...
        libraryManager.loadLibrary(Library.builder().groupId("com{}github{}ben-manes{}caffeine").artifactId("caffeine").version("3.0.2").relocate("com{}github{}benmanes{}caffeine", "com{}github{}beelzebu{}lib{}caffeine").build());
        libraryManager.loadLibrary(Library.builder().groupId("com{}zaxxer").artifactId("HikariCP").version("4.0.3").relocate("com{}zaxxer{}hikari", "com{}github{}beelzebu{}lib{}hikari").build());
        libraryManager.loadLibrary(Library.builder().groupId("org{}mariadb{}jdbc").artifactId("mariadb-java-client").version("2.7.3").relocate("org{}mariadb{}jdbc", "com{}github{}beelzebu{}lib{}mariadb").build());
        libraryManager.loadLibrary(Library.builder().groupId("org{}apache{}commons").artifactId("commons-pool2").version("2.9.0").relocate("org{}apache{}commons{}pool2", "com{}github{}beelzebu{}lib{}commonspool2").build());
        libraryManager.loadLibrary(Library.builder().groupId("redis{}clients").artifactId("jedis").version("3.6.0").relocate("redis{}clients{}jedis", "com{}github{}beelzebu{}lib{}jedis").build());
        libraryManager.loadLibrary(Library.builder().groupId("org{}mongodb").artifactId("mongo-java-driver").version("3.12.8").relocate("com{}mongodb", "com{}github{}beelzebu{}lib{}mongodb").relocate("org{}bson", "com{}github{}beelzebu{}lib{}bson").build());
        libraryManager.loadLibrary(Library.builder().groupId("dev{}morphia{}morphia").artifactId("morphia-core").version("2.2.1").relocate("dev{}morphia", "com{}github{}beelzebu{}lib{}morphia").build());
