...
public class BungeeUtil {
    ...
    public static void move(@NotNull Player player, @NotNull String server) {
        ...
        out.writeUTF(server);
        player.sendPluginMessage(MatrixPaper.getPlugin(MatrixPaper.class), "BungeeCord", out.toByteArray());
    }
    ...
    public static void move(@NotNull Player sender, @NotNull String name, @NotNull String server) {
        ...
        out.writeUTF(name);
        out.writeUTF(server);
        sender.sendPluginMessage(MatrixPaper.getPlugin(MatrixPaper.class), "BungeeCord", out.toByteArray());
    }
}
